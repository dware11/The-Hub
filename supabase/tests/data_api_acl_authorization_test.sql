...
select throws_like($$update public.announcements set title='blocked' where id='20000000-0000-4000-8000-000000000303'$$,'permission denied%','contributor cannot modify another submission');
