...
export async function getPendingQueue() {
  ...
  const [sessions, artifacts, suggestions] = await Promise.all([
    ...
    supabase.from('source_artifacts').select('id, intake_session_id, source_type, original_filename, storage_path, mime_type, byte_size, page_count, processing_status, warnings, created_at').in('intake_session_id', sessionIds),
